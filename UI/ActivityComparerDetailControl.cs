...
{
    internal partial class ActivityComparerDetailControl : UserControl
    {
        #region Fields
        ...
        private static ActivityComparerDetailControl control;
        ...
        internal void SetActivities(IEnumerable<IActivity> activities)
        {
            ...
            {
                DetailMenuItem_Click(cadenceToolStripMenuItem, null);
            }
            else
            {
                DetailMenuItem_Click(powerToolStripMenuItem, null);
        ...
        /// Restricted feature
        /// </summary>
        internal void ScreenLock(bool enable)
        {
            if (enable)
            {
                pnlLock.Show();
        ...
        //{
        //    Image imgLock = Resources.Images.Image_100_GreyLock;
        //    Point location = new Point(zedChart.Size.Width / 2 - imgLock.Width, zedChart.Size.Height / 2 - imgLock.Height);
        //    lockGraphic = zedChart.CreateGraphics();
        //    lockGraphic.DrawImage(imgLock, location);
        //    lockGraphic.Dispose();
        //}
        ...
        {
            ActivityComparerDetail.Instance.PageMaximized = !ActivityComparerDetail.Instance.PageMaximized;
        }
        ...
        {
            pnlLock.Size = zedChart.Size;
        }

        private void pnlLock_Resize(object sender, EventArgs e)
        {
            //btnUpgrade.Location = new Point(pnlLock.Width / 2 - 152, pnlLock.Height / 2 + 71);
            lblUpgrade.Location = new Point(pnlLock.Width / 2 - 27, pnlLock.Height / 2 + 78);
        }
        ...
        //{
            ...
            //{
            //    pageActivate = new Util.Activation();
            //}

            //pageActivate.Show();

            //if (DateTime.Now < new DateTime(2010, 08, 30))
            //{
            //    MessageDialog.Show("More info coming soon.  In the meantime, enjoy the unlocked version.");
            //    MeanMaxDetail.betaUnlock = true;
            //    ScreenLock(false);
            //}
        //}
    }
